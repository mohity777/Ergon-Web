...
const SQCardDetails = (props) => {
  return (
    <div className={style.sqContainer}>
      <div className={`${style.sqCard} ${styles.sqCardDetails}`}>
        <div className={`${style.up} ${styles.sqCardDetailsTop}`}>
          ...
          <div className={style.right}>
            <button className={`${style.applyBtn} ${styles.payDueBtn}`}>Pay due in 45 Days</button>
          </div>
        </div>
        <div className={`${style.middle} ${styles.sqCardDetailsMiddle}`}>
          ...
          <div className={styles.poDesignRow} style={{ width: "fit-content", marginTop: 0 }}>
            <h5 className={styles.poDesignText}>Status</h5>
            <DropdownPicker title="All Days" items={items} />
          </div>
          <div className={style.middle} style={{width: 'fit-content', alignSelf: 'flex-end'}}>
