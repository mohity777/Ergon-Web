...
const AllOuotes = (props) => {
  return (
    <SQDashboard allquotes="All Quotes" approvedquotes="Approved Quotes" receivednda="Received NDA" rfqdetail="RFQ Detail" rfqs="RFQ" fabricationScrew="Fabrication Screw">
    <div className="App">
